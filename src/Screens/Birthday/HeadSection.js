    ...
    return (
        <>
            <div className="pt-5" >
                ...
                <p className="font-poppins fw-bold fs-7vw text-center text-white mx-auto w-18ch mt-4" > Celebrate Bday
                    With Thrill Zone</p>
                <p className='my-4 font-poppins fs-18 text-white-80 text-center w-50 mx-auto fw-700'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
