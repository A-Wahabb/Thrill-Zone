...
const Footer = ({ Scndref, children }) => {
    ...
    return (
        <>
            ...
            <div className="main-bg clip-test w-108 position-absolute top-30 pt-4 pb-3 start-50 translate-middle-x" ref={firstDivRef}>
                    ...
                    <div className="row footer-pad gap-3 gap-md-0">
                        <div className="col-12 col-md-6 col-lg d-flex flex-column gap-3 align-items-start">
                            ...
                            <div className="d-flex gap-3">
                                <div className="bg-white rounded-circle py-1 px-2">
